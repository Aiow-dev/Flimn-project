...
namespace Flimncourse {
	...
	public:
		...
		Load_screen(void)
		{
			...
			if (key_advice == 12) {
				label2->Text = "Совет: Используя приложение, вы подтверждаете настоящую политику конфиденциальности Flimn. Ознакомиться с политикой конфиденциальности можно в настройках";
			}
		}
	protected:
		/// <summary>
